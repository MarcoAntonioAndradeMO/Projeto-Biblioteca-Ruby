...
class EmployersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employer" do
    assert_difference("Employer.count") do
      post employers_url, params: { employer: { date: @employer.date, effectuation_date: @employer.effectuation_date, function: @employer.function, proper_name: @employer.proper_name, resignation_date: @employer.resignation_date } }
    end
  ...
  test "should update employer" do
    patch employer_url(@employer), params: { employer: { date: @employer.date, effectuation_date: @employer.effectuation_date, function: @employer.function, proper_name: @employer.proper_name, resignation_date: @employer.resignation_date } }
